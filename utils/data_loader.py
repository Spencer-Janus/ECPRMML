...
def read_feature():
    PictureFeature=np.load('list_picture.npy')
    TextFeature=np.load('list_text.npy')
    return PictureFeature,TextFeature
...
def load_data(model_args):
    ...
    PictureFeature,TextFeature=read_feature()

    return train_cf, test_cf, user_dict, n_params, graph, \
           [adj_mat_list, norm_mat_list, mean_mat_list],triplets,relation_dict,PictureFeature,TextFeature
